...
class Dailymotion
{
    ...
    {
        $url = 'https://api.dailymotion.com/video/' . $id . '?fields=id,title,description,tags,thumbnail_url,duration,views_total';
        ...
        return [
            ...
            'views'=>! empty($json['views_total']) ? $json['views_total'] : null,
            'api' => true
        ];
    }
